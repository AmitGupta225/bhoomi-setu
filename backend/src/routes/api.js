...
import { handler_6, handler_7, handler_8, handler_9, handler_update_parcel, handler_delete_parcel } from '../controllers/parcelController.js';
...
router.put('/parcels/:id', handler_update_parcel);
router.delete('/parcels/:id', handler_delete_parcel);
